declare namespace NodeJS {
  export interface ProcessEnv {
    ...
    NEXT_PRIVATE_OIDC_AUTO_REDIRECT?: string;

    NEXT_PRIVATE_DATA_RETENTION_ENABLED?: string;
    NEXT_PRIVATE_DATA_RETENTION_DAYS?: string;
    NEXT_PRIVATE_DATA_RETENTION_COMPLETED_ONLY?: string;
